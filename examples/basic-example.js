...
const VizSeedBuilder_1 = require("../src/builder/VizSeedBuilder");
const sampleData = {
    fields: [
        {
            name: 'category',
...
function createBarChart() {
    const builder = new VizSeedBuilder_1.VizSeedBuilder(sampleData);
...
function createLineChart() {
    ...
    const builder = new VizSeedBuilder_1.VizSeedBuilder(timeSeriesData);
    const vizSeed = builder
        .setChartType('line')
        .addDimension('date')
        .addMeasure('revenue')
